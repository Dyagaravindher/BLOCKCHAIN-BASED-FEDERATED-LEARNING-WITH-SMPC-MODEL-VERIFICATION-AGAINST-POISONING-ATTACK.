"""blockchain_based_federated_learning URL Configuration
...
from blockchain_based_federated_learning import settings
...
urlpatterns = [
    ...
    url(r'^predict_poisoning_attack/$', remoteuser.predict_poisoning_attack, name="predict_poisoning_attack"),
    ...
    url(r'^View_Prediction_Of_Poisoning_Attack_Type_Ratio/$', serviceprovider.View_Prediction_Of_Poisoning_Attack_Type_Ratio, name="View_Prediction_Of_Poisoning_Attack_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Poisoning_Attack_Type/$', serviceprovider.View_Prediction_Of_Poisoning_Attack_Type, name="View_Prediction_Of_Poisoning_Attack_Type"),
